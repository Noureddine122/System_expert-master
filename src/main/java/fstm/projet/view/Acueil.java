...
public class Acueil extends JFrame {
    ...
    public Acueil(fstm.projet.model.bo.Client c) throws IOException, ClassNotFoundException {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) throws IOException, ClassNotFoundException {
